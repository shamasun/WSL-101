...
- From the start button on the windows taskbar, run the Ubuntu-20.04 application. 
    > If you get an error that the VM could not be started because the required feature could not be installed, this means that the hypervisor is not properly installed. Please enable Hyper-V from BIOS.  
